/**
  ...
  @File Name:
    MESCAN1_DefinitionVariable.h

  @Summary:
    This is the MESCAN1_DefinitionVariable.h file generated using PIC24 / dsPIC33 / PIC32MM MCUs
...
#ifndef MESCAN1_DEFINITION_VARIABLE_H
#define	MESCAN1_DEFINITION_VARIABLE_H
